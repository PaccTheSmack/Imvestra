...
const INPUT =
  "w-full bg-[#F5F5F5] rounded-[10px] px-3.5 py-2.5 text-sm text-[#101418] placeholder:text-[#9CA3AF] focus:outline-none focus:bg-white focus:border focus:border-[rgba(160,120,48,0.3)] focus:ring-1 focus:ring-[rgba(160,120,48,0.1)] transition-all duration-150 border border-transparent";
const LABEL = "block text-xs font-medium text-[#6B7280] mb-1.5";
const SECTION_LABEL =
  "text-[9px] font-bold text-[#9CA3AF] uppercase tracking-[0.14em] mb-4";
  ...
  return (
    <div className="px-8 py-7 w-full" style={{ background: "#F8F7F4", minHeight: "100vh" }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* ── LEFT – Inputs ── */}
        <div
          className="bg-white rounded-[14px] border border-[rgba(0,0,0,0.07)] shadow-[0_1px_3px_rgba(0,0,0,0.06),0_4px_16px_rgba(0,0,0,0.04)] p-6 flex flex-col gap-6"
        >
                ...
                <button
                  ...
                  style={
                    targetYield === y && customYield === ""
                      ? { background: "#A07830", color: "#FFFFFF" }
        ...
        <div>
          {!hasData ? (
            <div
              className="bg-white rounded-[14px] border border-[rgba(0,0,0,0.07)] shadow-[0_1px_3px_rgba(0,0,0,0.06),0_4px_16px_rgba(0,0,0,0.04)] flex flex-col items-center justify-center py-16 px-8 text-center"
            >
              <motion.div
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Hero max Kaufpreis — dark gold */}
              <div className="bg-[#A07830] rounded-[14px] px-6 py-6 text-center">
                <p
                ...
                <MetricValue
                  ...
                  className="text-[32px] font-bold tracking-[-0.03em] text-white"
                />
              ...
              {pp > 0 && (() => {
                ...
                const verdictColor =
                  cmp.verdict === "angemessen"           ? "#2D6A2D"
                  : cmp.verdict === "verhandlungsbedarf" ? "#92400E"
                  : "#B91C1C";
                const verdictBg =
                  cmp.verdict === "angemessen"           ? "rgba(45,106,45,0.08)"
                  : cmp.verdict === "verhandlungsbedarf" ? "rgba(146,64,14,0.1)"
                  : "rgba(185,28,28,0.08)";
                const verdictLabel =
                ...
                return (
                  <div
                    className="bg-white rounded-[14px] border border-[rgba(0,0,0,0.07)] shadow-[0_1px_3px_rgba(0,0,0,0.06),0_4px_16px_rgba(0,0,0,0.04)] px-5 py-5"
                  >
                    ...
                    <div className="mb-4">
                      ...
                      >
                        <div
                          ...
                          style={{ width: `${greenPct}%`, background: "#2D6A2D" }}
                        />
                        {redPct > 0 && (
                          <div
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{ color: cmp.potential_savings > 0 ? "#B91C1C" : "#2D6A2D" }}
                      >
              ...
              >
                ...
                {[
                  ...
                  >
                    <span className="text-xs" style={{ color: dim ? "#9CA3AF" : "#6B7280" }}>
                      {label}
                    </span>
                    <span
              ...
              <div
                ...
                style={{ background: "rgba(160,120,48,0.08)", border: "1px solid rgba(160,120,48,0.18)" }}
              >
                <PiggyBank size={14} color="#A07830" className="mt-0.5 flex-shrink-0" />
