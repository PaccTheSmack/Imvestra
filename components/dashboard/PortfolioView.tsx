...
const TYPE_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  ETW:     { bg: "rgba(29,184,122,0.1)",   text: tokens.color.accent,  border: "rgba(29,184,122,0.2)" },
  MFH:     { bg: "rgba(139,92,246,0.1)",   text: "#A78BFA",            border: "rgba(139,92,246,0.2)" },
  EFH:     { bg: "rgba(29,184,122,0.08)",  text: tokens.color.accent,  border: "rgba(29,184,122,0.15)" },
