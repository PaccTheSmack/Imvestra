...
const INPUT =
  "w-full bg-[#141414] border border-[rgba(255,255,255,0.07)] rounded-[8px] px-3 py-2.5 text-sm text-white placeholder:text-[#555555] focus:outline-none focus:border-[rgba(29,184,122,0.4)] focus:bg-[#1A1A1A] transition-all duration-150";
                      ...
                      <div className="col-span-2 flex gap-6">
                        <label className="flex items-center gap-2 text-sm cursor-pointer" style={{ color: tokens.color.text }}>
                          <input
                            ...
                            className="w-4 h-4 accent-[#1DB87A]"
                          />
                          ...
                          {!pp || !builtYear ? (
                            ...
                            <>
                              ...
                              <div
                                ...
                                style={{ background: tokens.color.positiveBg, border: `1px solid rgba(29,184,122,0.15)` }}
                              >
