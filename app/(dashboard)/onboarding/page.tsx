      ...
      >
        ...
        <div className="px-6 py-8">
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                <h1
                  className="text-[22px] font-semibold text-[#101418] tracking-[-0.02em]"
                >
            ...
            {step === 3 && (
              ...
              >
                ...
                >
                  <CheckCircle size={32} color="#2D6A2D" weight="fill" />
                </motion.div>
        ...
        >
          ...
          <button
            ...
            onMouseEnter={(e) => { if (!e.currentTarget.disabled) e.currentTarget.style.background = "#A07830"; }}
            onMouseLeave={(e) => { if (!e.currentTarget.disabled) e.currentTarget.style.background = "#A07830"; }}
          >
