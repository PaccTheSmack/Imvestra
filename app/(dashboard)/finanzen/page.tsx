...
const FEATURES = [
  {
    Icon: CreditCard,
    title: "Zinsbindungsende-Tracker",
    body: "Warnungen wenn Zinsbindungen auslaufen.",
  },
  {
    Icon: Percent,
    title: "Anschlussfinanzierungsrechner",
    body: "Was passiert wenn die Zinsen steigen?",
  },
  {
    Icon: ChartLine,
    title: "Cashflow-Entwicklung",
    body: "Monatlicher Cashflow uber alle Objekte.",
  },
  {
    Icon: Bank,
    title: "Bankverbindungen",
    body: "Finanzierungen und Konditionen verwalten.",
  },
];
